...
public class CreateJobAPIWithDBValidationTest2 {
	...
	public void setup() {
		...
		customerAddress = new CustomerAddress("010", "Vrindavan", "quarter", "Chennai", "AAA", "560102", "India",
				"TamilNadu");
		customerProduct = new CustomerProduct(getTimeWithDayAgo(10), "66533799807096", "66533799807096",
				"66533799807096", getTimeWithDayAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
	...
	public void createJobAPITest() {
		...
		CreateJobResponseModel response = given().spec(requestSpecWithAuthBody(Role.FD, createJobPayload)).log().all().when()
